...
export function QuestionBankPage() {
  ...
  const questions = [
    { id: "Q001", title: "Phân tích độ phức tạp Bubble Sort", topic: "Cấu trúc dữ liệu & Giải thuật", difficulty: "Dễ", tags: ["sorting", "bubble-sort", "complexity"] },
    { id: "Q002", title: "Hiện thực Binary Search trên mảng tĩnh", topic: "Kỹ thuật lập trình C++", difficulty: "Trung bình", tags: ["search", "binary-search", "array"] },
    { id: "Q003", title: "Thiết kế danh sách liên kết kép (Double Linked List)", topic: "Cấu trúc dữ liệu & Giải thuật", difficulty: "Khó", tags: ["linked-list", "pointers"] },
    { id: "Q004", title: "Hiện thực Stack bằng mảng một chiều", topic: "Kỹ thuật lập trình", difficulty: "Dễ", tags: ["stack", "array", "data-structures"] },
    { id: "Q005", title: "So sánh hiệu năng Quick Sort và Merge Sort", topic: "Cấu trúc dữ liệu & Giải thuật", difficulty: "Khó", tags: ["sorting", "quick-sort", "merge-sort"] },
  ];
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              {filtered.map((q) => (
                <tr key={q.id}>
                  <td style={{ fontWeight: 600, color: "#C92328" }}>{q.id}</td>
