...
import { createAssignment, getRubricTemplatesApi, type RubricTemplate } from "../api/client";
...
export default function NewAssignmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Lỗi tạo đề bài");
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div className="page-header">
          <div>
            <div className="breadcrumb">
              <Link to="/teacher">Lớp học</Link> / Tạo đề bài mới
            </div>
